...
const FILE_LOC_MULTIPLIERS: Record<string, number> = {
	...
	".rs": 2.5,
	".go": 1.5,
	// C++ files can't be split into separate translation units without
	// promoting internal-linkage helpers to public API, so cohesive C/C++
	// modules idiomatically run long - give them the same budget Rust gets.
	...Object.fromEntries([...CPP_SOURCE_EXTENSIONS].map((extension) => [extension, 2.5])),
};
