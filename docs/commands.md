...
| `aislop scaffold component <name>` | Generate a C++ component-as-translation-unit scaffold (experimental) |
| `aislop cpp sync-internal <component>` | Regenerate editor-only declarations for C++ component fragments (experimental) |
...
| `aislop init` | `--strict` |
| `aislop scaffold component <name>` | `--dir <path>`, `--fragment <fragment>`, `--adopt` |
